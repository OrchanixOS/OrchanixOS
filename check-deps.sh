...
# building OrchanixOS installed on your system. Only needed if you are building on
# a non-OrchanixOS distro, as OrchanixOS has all the necessary dependencies built-in.
...
if [ ! -e /etc/orchanixos-release ]; then
  ...
  echo "building from an existing installation of OrchanixOS." >&2
fi
